...
//CALCULO DA II
if($a0numeroSequencialItem = 01) {
    if ($a0quantidade > 0) {
        $qp = round(($quantidade0 / 100000), 2);                     #Quantidade de Produtos
        $vud = round(($valorUnitario0 / 100000), 2);                 #Valor unitário em dólar
        ...
        echo '<th id="thCalcMedio">VU II<br><br><input id="inputCalcPequeno"type="text" value="' . $viiu . '"></th>';          #resultado
        ...
        echo '<th id="thCalcMedio">VT Produto<br><br><input id="inputCalcMedio" type="text" value="' . $vtcr . '"></th>';       #resultado
...
//3.2.2.1  Calculo de Imposto (II)
        ...
        echo '<th id="thCalcMedio">Valor Unitário II<br><br><input id="inputCalcMedio" type="text" value="' . $viiu . '"></th>'; #resultado
...
//3.2.3 IPI
        ...
        echo '<th id="thCalcMedio">IPI<br><br><input id="inputCalcPequeno" type="text" value="' . $vipi . '"></th>';             #resultado
...
//3.2.4 PIS
        ...
        echo '<th id="thCalcMedio">PIS (R$)<br><br><input id="inputCalcPequeno" type="text" value="' . $vpis . '"></th>';         #resultado
...
//3.2.5 COFINS
        ...
        echo '<th id="thCalcMedio">COFINS<br><br><input id="inputCalcPequeno" type="text" value="' . $vcf . '"></th>';            #resultado
...
//3.2.7 ICMS Base Secundaria
        ...
        $icms = '0.12';                                                   #valor icms
        $vicms = $vbics * $icms;
        $vicms = round(($vicms / 000001), 2);

        echo '<th id="thCalcMedio0">ICMS <br><br><input id="inputCalcPequeno" type="text" value="' . $vicms . '"></th>';       #resultado
//Taxa siscomex
        echo '<th id="thCalcMedio0">SISCOMEX <br><br><input id="inputCalcPequeno" type="text" value=""></th></tr></table>';    #resultado
    }
}
?>